...
STRATEGY_INFO = {
    ...
    "FormPeakSanrentan": {
        "label":    "好調ライン先頭・三連単1着固定",
        "bet":      "三連単",
        "emoji":    "🚀",
        "summary":  "前走好成績かつライン先頭の選手を1着固定として、ライン内2・3番手との三連単で高配当を狙う戦略。",
        "detail": [
            "✅ 直近着順が **2着以内**（直前で好走した選手が核心）",
            "✅ **ライン先頭必須**（1着になりやすい逃げ選手のみ）",
            "✅ 人気 **3〜10番手**（中〜大穴で配当が大きい）",
            "✅ 3車ライン以上で1着固定→ライン内2〜3着の三連単を購入",
        ],
        "point": "バックテストで平均払戻12,491円・回収率502%。件数は絞られるが1発の破壊力が大きい。",
    },
    "FormPeakSanrenfuku": {
        "label":    "好調選手・三連複軸狙い",
        "bet":      "三連複",
        "emoji":    "🎯",
        "summary":  "前走好成績の好調選手を軸に、ライン内の仲間との三連複（着順不問3頭）で狙う戦略。",
        "detail": [
            "✅ 直近着順が **3着以内**（好調な選手のみ）",
            "✅ ライン内の選手との組み合わせで購入（ライン決着を狙う）",
            "✅ 人気 **3〜10番手**（中穴ゾーン）",
            "✅ 三連単より的中しやすく、それでも高配当が期待できる",
        ],
        "point": "バックテストで平均払戻1,703円・回収率208%。三連単ほどのインパクトはないが安定感がある。",
    },
}
